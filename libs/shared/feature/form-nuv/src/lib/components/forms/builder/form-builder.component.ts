...
import { BehaviorSubject, EMPTY, Observable, Subject, Subscription, catchError, finalize, forkJoin, switchMap, take, tap } from 'rxjs';
...
export class FormBuilderComponent implements DoCheck, OnDestroy {
  ...
  public formData$?: Observable<Record<string, unknown>>;
